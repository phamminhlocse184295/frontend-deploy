...
const WorkVolume = () => {
  ...
  const getColumnSearchProps = (
    ...
    filterDropdown: ({
      ...
      <div style={{ padding: 8 }} onKeyDown={(e) => e.stopPropagation()}>
        {dataIndex === "ngaytaobangkhoiluong" ? (
          <DatePicker
          ...
          <AntInput // Use AntInput instead of Input
            ref={searchInput}
    ...
    onFilter: (value, record) => {
      if (dataIndex === "ngaytaobangkhoiluong") {
  ...
  const columns: ColumnsType<DataType> = [
    ...
    { title: "Số hợp đồng", dataIndex: "sohopdong", key: "sohopdong" },
    {
      ...
      dataIndex: "sodonhang",
      key: "sodonhang",
      ...getColumnSearchProps("sodonhang"),
      sorter: (a, b) => a.sodonhang - b.sodonhang,
      sortDirections: ["descend", "ascend"],
    },
    {
      title: "Nhà thầu phụ",
      dataIndex: "nhathauphu",
      key: "nhathauphu",
      ...getColumnSearchProps("nhathauphu"),
      sorter: (a, b) => a.nhathauphu.localeCompare(b.nhathauphu),
      sortDirections: ["descend", "ascend"],
    },
    {
      title: "Dự án",
      ...
      sorter: (a, b) => a.duan.localeCompare(b.duan),
      sortDirections: ["descend", "ascend"],
    },
    {
      title: "Ngày tạo bảng khối lượng",
      dataIndex: "ngaytaobangkhoiluong",
      key: "ngaytaobangkhoiluong",
      ...getColumnSearchProps("ngaytaobangkhoiluong"),
    },
    {
      title: "Tên gói thầu",
      dataIndex: "tengoithau",
      key: "tengoithau",
      ...getColumnSearchProps("tengoithau"),
      sorter: (a, b) => a.tengoithau.localeCompare(b.tengoithau),
      sortDirections: ["descend", "ascend"],
    },
    {
      title: "Trạng thái",
  ...
  return (
    <div>
      <div className="content-header">Danh sách bảng khối lượng</div>
